...
! input_version = 2 is does input of new variables for sectional aerosol
      ...
      READ(789,*) VOC,VOC_MW,VOC_kOH,VOC_CSAT,VOC_CNO
      CLOSE(789)
      ...
      if (input_version == 1) then
         ...
         ALLOCATE(jk_OLGMOLE_OXY(nCOMP,nBINS))

         k_DIAM_DRY(:) = 0.d0
         k_NUM(:) = 0.d0

         jk_PARMOLE_SOM(:,:) = 1.d-60
         jk_PARMOLE_SOM_2(:,:) = 1.d-60

         jk_OLGMOLE_SOM(:,:) = 1.d-60
         jk_OLGMOLE_OXY(:,:) = 1.d-60
         
         jk_PARMOLE_OXY(:,:) = 1.d-60
...
!      STOP
      ...
      OPEN(UNIT=345,FILE='inputs/in.DIAM0',STATUS='old')
      READ(345,*) k_DIAM0
      CLOSE(345)
