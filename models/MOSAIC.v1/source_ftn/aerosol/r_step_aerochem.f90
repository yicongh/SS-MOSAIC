...
!    UPDATE SOM AND OXYGEN SPECIES:
!    ======================================================================================
!    UPDATE OXY. SPECIES:
     DO j = 1,nCOMP
     DO k = 1,nBINS
!    O:C RATIO:
     O2C = MIN(jk_PARMOLE_OXY(j,k)/jk_PARMOLE_SOM(j,k),2.0)   

!    CHANGE IN SOM SPECIES:   
     dSOM = jk_PARMOLE_SOM_NEXT(j,k) - jk_PARMOLE_SOM(j,k)
